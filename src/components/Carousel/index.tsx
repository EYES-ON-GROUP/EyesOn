  ...
  const slides: Slide[] = [
    {
      ...
      title: "Jean Dupont",
      content: "otot",
      backgroundColor: "bg-[#1e4d91]", // Blue
    },
    {
      id: 2,
      title: "Marie Curie",
      ...
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row lg:items-center lg:justify-center rounded-2xl" >
        ...
        <div className="mb-2 lg:mb-1 lg:w-1/4">
          ...
          <div className="mt-1 flex items-center gap-4 justify-center lg:justify-start">
            ...
            <button
              onClick={nextSlide}
              className="flex h-12 w-12 items-center font-raleway justify-center rounded-full bg-[#1e4d91] text-white transition-colors hover:bg-blue-700"

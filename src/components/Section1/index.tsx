  ...
  return (
    ...
    <div className="z-40 absolute top-1/2 left-0 md:left-32 py-10 px-5 lg-px-0 md:rounded-3xl md:w-[70%] lg:w-[35%]  bg-white bg-opacity-20  text-white -translate-y-1/2">
      <p className="text-4xl  font-semibold">
        La solution de{" "}
        <span className="text-orange">contrôle parental</span> et bien-être
        numérique optimale
      </p>

      <div className="mt-5 lg:mt-10 gap-10 flex max-md:justify-between md:gap-10">
        <Link to="" className="flex px-8 gap-1 place-items-center md:gap-4 rounded-xl transition-all duration-300 ease-in-out py-3 hover:bg-dark-blue   bg-blue">
          <p className='max-md:text-xs'>View Demo</p>
          <img src="/assets/images/vision.png" alt="" className="" />
        </Link>
        <Link to="" className="flex px-8 gap-1 place-items-center md:gap-4 rounded-xl transition-all duration-300 ease-in-out py-3 bg-orange orange-link">
